...
class Enviar {
	 ...
	 * @throws NfeException
	 */
	static TRetEnviNFe enviaNfe(TEnviNFe enviNFe, Tipo tipo) throws NfeException {
		...
		boolean nfce = tipo.equals(Tipo.NFCE.get());
		String qrCode = "";
		...
		try {
			...
			NFeAutorizacao4Stub stub = new NFeAutorizacao4Stub(
					nfce ? WebServiceUtil.getUrl(Tipo.NFCE, ConstantesUtil.SERVICOS.ENVIO)
							: WebServiceUtil.getUrl(Tipo.NFE, ConstantesUtil.SERVICOS.ENVIO));
			// Timeout
