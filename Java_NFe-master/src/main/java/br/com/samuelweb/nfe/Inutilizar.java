...
class Inutilizar {
	...
	static TInutNFe criaObjetoInutiliza(String id, String motivo, Tipo tipo) throws NfeException {
		...
		infInut.setId(id);
		infInut.setTpAmb(config.getAmbiente().toString());
		...
		infInut.setMod(tipo.equals(Tipo.NFE) ? "55" : "65");
	...
	static TRetInutNFe inutiliza(String id, String motivo, Tipo tipo, boolean validar) throws NfeException {
